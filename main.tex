...
\author{S. Hern\'andez-Barajas$^{1}$, Y. Le\'on-Carre\~no$^{1}$, J. Pe\~na-Rodr\'iguez$^{2}$, L. A. N\'u\~nez$^{2,3}$\\ for the LAGO collaboration% <-this % stops a space
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.42\textwidth]{Figures/Base.eps}
